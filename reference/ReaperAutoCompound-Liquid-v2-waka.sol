 ...
 */
contract ReaperAutoCompoundLiquidv2_Waka is Ownable, Pausable {
    ...
    address public constant wakaRouter = address(0x7B17021FcB7Bc888641dC3bEdfEd3734fCaf2c87);
    ...
    constructor(
        ...
        tokenRouter[lpToken0] = wakaRouter;
        tokenRouter[lpToken1] = wakaRouter;
    ...
    function addLiquidity() internal {
        ...
        IUniswapRouterETH(wakaRouter).addLiquidity(
            lpToken0,
            lpToken1,
            lp0Bal,
            lp1Bal,
    ...
    function giveAllowances() internal {
        ...
        IERC20(wftm).safeApprove(wakaRouter, 0);
        IERC20(wftm).safeApprove(wakaRouter, uint256(-1));

        IERC20(lpToken0).safeApprove(wakaRouter, 0);
        IERC20(lpToken0).safeApprove(wakaRouter, uint256(-1));

        IERC20(lpToken1).safeApprove(wakaRouter, 0);
        IERC20(lpToken1).safeApprove(wakaRouter, uint256(-1));
    }
