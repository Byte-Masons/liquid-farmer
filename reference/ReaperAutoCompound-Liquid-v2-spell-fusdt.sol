...
contract ReaperAutoCompoundLiquidv2_Spirit_SPELL is Ownable, Pausable {
    ...
    function addLiquidity() internal {
        ...
        IUniswapRouterETH(tokenRouter[lpToken0]).swapExactTokensForTokensSupportingFeeOnTransferTokens(balance, 0, wftmTofUSDTRoute, address(this), now.add(600));
        

        uint256 half = IERC20(fUSDT).balanceOf(address(this)).div(2);
        IUniswapRouterETH(tokenRouter[lpToken1]).swapExactTokensForTokensSupportingFeeOnTransferTokens(half, 0, fUSDTToSPELLRoute, address(this), now.add(600));
